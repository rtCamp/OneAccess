...
abstract class Abstract_REST_Controller extends \WP_REST_Controller implements Registrable {
	 ...
	 */
	public const NAMESPACE = 'oneaccess/v1';
	...
	/**
	 * Checks for the use of the OneAccess API key in the request headers.
	 *
	 ...
	 * @param string $rest_namespace The REST namespace. Default: oneaccess/v1).
	 *
