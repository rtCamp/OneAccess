...
final class Autoloader {
	...
	public static function autoload(): bool {
		...
		if ( defined( 'ONEACCESS_AUTOLOAD' ) && false === ONEACCESS_AUTOLOAD ) {
			return true;
		}
		...
		$autoloader      = ONEACCESS_DIR . 'vendor/autoload.php';
		...
		foreach ( $hooks as $hook ) {
			add_action(
				...
				static function (): void {
					$error_message = __( 'OneAccess: The Composer autoloader was not found. If you installed the plugin from the GitHub source code, make sure to run `composer install`.', 'oneaccess' );
